...
export default function EducationForm({ education, onChange }) {
  ...
  return (
    <form
      className="flex flex-col bg-white rounded-md shadow-md p-6 gap-2"
      onSubmit={handleSubmit}
    >
      <h1 className="font-bold text-3xl">Education</h1>
      <FormComponent label="School" name="school" />
      ...
      <button
        className="cursor-pointer bg-sky-900 text-white font-semibold w-fit px-4 py-2 rounded-md ml-auto mr-4 mt-2"
        type="submit"
      >
        Add education
      </button>
